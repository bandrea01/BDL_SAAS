...
const Viewer = () => {
  ...
  return (
    <div className="sm:w-full h-full relative flex">
      <div className="sm:w-full full pt-20 relative">
        <h1 className="text-blue text-6xl px-[300px] font-bold justify-left">
          {i18n.t("viewer.title")}
        </h1>
        <div className="py-[50px] px-[70px] h-[1000px]">
          ...
          <div className="items-center h-full justify-center relative object-contain">
            <IFCViewer />
          </div>
        </div>
      </div>
